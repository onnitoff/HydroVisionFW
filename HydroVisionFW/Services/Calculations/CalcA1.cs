...
namespace HydroVisionFW.Services.Calculations
{
    internal class CalcA1
    {
        ...
        public void Calculations()
        {
            ...
            A1Storage.Instance.g_cnA = filters.WaterConsumptionForOwnNeeds(A1Storage.Instance.SumV_vlK, A1Storage.Instance.P_iA, A1Storage.Instance.n);
            ...
            A1Storage.Instance.Q_br = filters.WaterConsumptionForTheNextGroupOfFilters(H2Storage.Instance.Q_br, A1Storage.Instance.g_cnA);
        }

        public void CaclFirstProperty()
        {
            CalculationOfIonExchangeFilters filters = new CalculationOfIonExchangeFilters();
            A1Storage.Instance.F = filters.FiltrationArea(H2Storage.Instance.Q_br, A1Storage.Instance.w);
