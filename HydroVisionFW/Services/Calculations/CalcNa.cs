...
namespace HydroVisionFW.Services.Calculations
{
    internal class CalcNa
    {
        ...
        public void Calculations()
        {
            ...
            NaStorage.Instance.T_FAA = filters.FilterCycleDurationForSimpleAndTwoStage(NaStorage.Instance.f_ct, NaStorage.Instance.h, NaStorage.Instance.e_pK, NaStorage.Instance.m, DataStorage.Instance.PerfomanceWTPForHeatingSystem, DataStorage.Instance.NaCationOnFilter);
            ...
            NaStorage.Instance.Q_br = filters.WaterConsumptionForTheNextGroupOfFilters(DataStorage.Instance.PerfomanceWTPForHeatingSystem, NaStorage.Instance.g_cnK);

            DataStorage.Instance.PerfomanceOF = NaStorage.Instance.Q_br + H1Storage.Instance.Q_br;
        }

        public void CaclFirstProperty()
        {
            CalculationOfIonExchangeFilters filters = new CalculationOfIonExchangeFilters();
            NaStorage.Instance.F = filters.FiltrationArea(DataStorage.Instance.PerfomanceWTPForHeatingSystem, NaStorage.Instance.w);
